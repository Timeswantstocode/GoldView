...
const externalTooltipHandler = (context) => {
  ...
  if (tooltip.body) {
    ...
    titleLines.forEach(title => {
      ...
      Object.assign(span.style, { fontSize: '8px', fontWeight: '800', textTransform: 'uppercase', marginBottom: '2px', opacity: '0.5', whiteSpace: 'nowrap' });
              ...
              {calcMode === 'jewelry' ? (
                <div className="space-y-6">
                  ...
                  <div className="mb-8 p-6 rounded-[2.2rem] border-2 flex items-center justify-between" style={{ borderColor: `${themeColor}80`, backgroundColor: `${themeColor}10` }}>
                    ...
                    <div className="text-right text-[10px] font-black text-zinc-500">{formatRS(parsePrice(priceData[priceData.length-1]?.[activeMetal === 'usd' ? 'gold' : activeMetal]))}</div>
                  </div>
